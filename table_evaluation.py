...
# def __derivative_cox_de_boor_table_basis_function(time, i, order , knot_points, end_time,  clamped):
#     table = __cox_de_boor_table_basis_function(time, i, order , knot_points, end_time,  clamped)
...
#                     table[y,kappa-1] * (1) / (t_i_y_k - t_i_y)
#             if t_i_y_k_1 > t_i_y_1:
#                 diagonal_term = d_table[y+1,kappa-1] * (t_i_y_k_1 - time)/(t_i_y_k_1 - t_i_y_1) + \
#                     table[y+1,kappa-1]*(-1)/(t_i_y_k_1 - t_i_y_1)
